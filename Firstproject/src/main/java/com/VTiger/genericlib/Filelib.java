...
public class Filelib
{
	...
	FileInputStream file=new FileInputStream("../Firstproject/CommanData.properties");
	...
	{
		Workbook workbook = WorkbookFactory.create(new FileInputStream("../Firstproject/TestScriptData.xlsx"));
